...
public class GoogleSearchTest {
    ...
    public void googleSearchButtonTest() {
        ...
        WebElement searchButtonElement = driver.findElement(By.xpath("//div[@class='FPdoLc tfB0Bf']//input[@name='btnK']"));
    ...
    public void googleFeelingLuckyButtonTest() {
        ...
        WebElement feelingLuckyElement = driver.findElement(By.xpath("//div[@class='FPdoLc tfB0Bf']//input[@name='btnI']"));
